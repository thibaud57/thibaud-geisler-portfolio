...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 ajouté au registry : sans lui, min-width:auto fait du w-full un plancher, et la
        // page défile de la largeur de la sidebar dès qu'un contenu large remplit cette colonne.
