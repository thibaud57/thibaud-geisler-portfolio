...
describe("contactSchema", () => {
  ...
  it('retourne le code "name_required" quand name est vide après trim', () => {
    ...
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.name).toEqual(["name_required"])
    }
  })
  ...
  it('retourne le code "subject_required" quand subject est vide', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.subject).toEqual(["subject_required"])
    }
  })
  ...
  it('retourne le code "name_too_long" quand name dépasse 120 caractères', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.name).toEqual(["name_too_long"])
    }
  })
  ...
  it('retourne le code "email_too_long" quand email dépasse 200 caractères', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.email).toContain("email_too_long")
    }
  })
  ...
  it('retourne le code "subject_too_long" quand subject dépasse 200 caractères', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.subject).toEqual(["subject_too_long"])
    }
  })
  ...
  it('retourne le code "company_too_long" quand company dépasse 200 caractères', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.company).toEqual(["company_too_long"])
    }
  })
  ...
  it('retourne le code "message_too_long" quand message dépasse 5000 caractères', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.message).toEqual(["message_too_long"])
    }
  })
  ...
  it('retourne le code "email_invalid" quand email ne matche pas le format', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.email).toEqual(["email_invalid"])
    }
  })
  ...
  it('retourne le code "message_too_short" quand message a moins de 20 caractères', () => {
    ...
    expect(result.success).toBe(false)
    if (!result.success) {
      expect(z.flattenError(result.error).fieldErrors.message).toEqual(["message_too_short"])
    }
  })
