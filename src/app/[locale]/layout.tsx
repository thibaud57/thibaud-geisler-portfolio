...
import { buildLanguageAlternates, localeToOgLocale, setupLocaleMetadata, siteUrl } from "@/lib/seo"
...
export default async function LocaleLayout({ children, params }: LayoutProps<"/[locale]">) {
  ...
  return (
    <html
      ...
      className={cn("h-full scroll-pt-16 antialiased motion-safe:scroll-smooth", fontVariables)}
    >
