...
> - **Ajouté** : enum `DataCategory` (IDENTITY, CONTACT, IP_ADDRESS, USAGE_DATA, TECHNICAL_LOGS, COOKIE_DATA) + `DataProcessing.dataCategories: DataCategory[]` (registre RGPD complet art. 13 §1 c).
