...
export const projects: ProjectInput[] = [
  ...
  },
  {
    ...
    descriptionEn:
      "Conversational module of an R&D program at a large account, through Theodo Extend. Multi-agent systems on Vertex AI and Google ADK, sandboxed code execution, hallucination control over business LLM chains.",
    type: "CLIENT",
    status: "PUBLISHED",
    formats: ["IA", "WEB_APP", "API"],
  ...
  },
  {
    ...
    descriptionEn:
      "Python/FastAPI REST gateway aggregating Beatport, Bandcamp and SoundCloud behind a single output contract. TLS impersonation to defeat anti-bot filtering, OAuth token management under strict quota, silent-failure detection. In production.",
    type: "PERSONAL",
    status: "PUBLISHED",
    formats: ["API"],
    startedAt: new Date("2026-07-07"),
    endedAt: new Date("2026-07-30"),
    githubUrl: null,
    demoUrl: null,
  ...
  },
  {
    ...
    tagSlugs: ["agents-ia", "n8n", "mcp", "automatisation", "anthropic", "docker", "dokploy"],
  },
  {
    slug: "rag-drive-agent",
    titleFr: "RAG Drive Agent (Telegram)",
    titleEn: "Telegram RAG Drive Agent",
    descriptionFr:
  ...
  },
  {
    ...
    tagSlugs: ["agents-ia", "skills", "anthropic"],
  },
]
